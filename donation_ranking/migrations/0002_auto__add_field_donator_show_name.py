...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Donator.show_name'
        db.add_column(u'donation_ranking_donator', 'show_name',
                      self.gf('django.db.models.fields.CharField')(default='Anonymous', max_length=64),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Donator.show_name'
        db.delete_column(u'donation_ranking_donator', 'show_name')
