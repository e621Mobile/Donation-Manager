...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Donator.show_name'
        db.alter_column(u'donation_ranking_donator', 'show_name', self.gf('django.db.models.fields.CharField')(max_length=32))

    def backwards(self, orm):

        # Changing field 'Donator.show_name'
        db.alter_column(u'donation_ranking_donator', 'show_name', self.gf('django.db.models.fields.CharField')(max_length=64))
    ...
    models = {
        ...
        u'donation_ranking.donator': {
            ...
            'highlight': ('django.db.models.fields.DateTimeField', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'ong': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['donation_ranking.ONG']"}),
            'show_name': ('django.db.models.fields.CharField', [], {'default': "'Anonymous'", 'max_length': '32'}),
