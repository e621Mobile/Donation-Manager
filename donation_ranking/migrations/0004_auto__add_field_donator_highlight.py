...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Donator.highlight'
        db.add_column(u'donation_ranking_donator', 'highlight',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2015, 6, 13, 0, 0)),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Donator.highlight'
        db.delete_column(u'donation_ranking_donator', 'highlight')
